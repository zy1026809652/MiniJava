...
{
       0,    92,    92,    93,    98,   103,   104,   109,   113,   117,
     121,   125,   130,   134,   139,   148,   158,   161,   168,   169,
     173,   177,   181,   185,   189,   193,   197,   201,   208,   211,
     218,   219,   220,   221,   222,   223,   224,   231,   232,   237,
...
#line 248 "src/parser.y"
                   { (yyval.ast) = new UnaryExpression(yylineno, NodeType::ARRAY_LENGTH, (yyvsp[-2].ast)); }
#line 1890 "y.tab.c"
    break;
